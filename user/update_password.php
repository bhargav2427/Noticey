...
<form method="post">
    ...
    <div class="row" style="margin-top:10px">
        ...
        <div class="col-sm-8">
            ...
            <input type="submit" value="Update Password" name="save" style="background-color:#fec810;border:0px"
                class="btn btn-success" />
            <input type="reset" class="btn btn-success" style="background-color:#fec810;border:0px" />
        </div>
    </div>
</form>